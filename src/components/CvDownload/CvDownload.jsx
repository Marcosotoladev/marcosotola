...
<div className="duration-300  hover:-rotate-0  -rotate-12 group border border-sky-900  overflow-hidden rounded-2xl relative h-52 w-72 bg-sky-800 p-5 flex flex-col items-start gap-4">
